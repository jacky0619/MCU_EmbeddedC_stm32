...
|# | Features          | link                           |
|--|:------------------|:-------------------------------|
|1 | SWV & Semihosting |[SWV](#SWV_Semihosting)         |
|2 | Debug options     |[Debug options](#Debug_options) |
|3 | USB analyzer      |[Analyzer](#USB_analyzer)       |
|4 | Bus interface     |[Bus](#Bus_interface)           |
|5 | Clock tree        |[Clock tree ](#Clock_tree )     |
|6 | Vector table      |[Vector table](#Vector_table)   |
|7 | GPIO              |[GPIO](#GPIO)                   |
|8 | SPI               |[SPI](#SPI)                     |
|9 | UART              |[UART](#UART)                   |
|10| RTC on LCD        |[RTC on LCD](#RTC_on_LCD)       |
...
2. Then we can see the current time and current date messeges setting in semihosting. 
![](https://i.imgur.com/wcXIygV.png)  
3. Practical connections with STM32F407, LCD, DS1307 and 10K potentiometer
